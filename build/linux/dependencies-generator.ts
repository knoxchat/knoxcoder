...
// KnoxCoder: the reference lists below were generated by the upstream VS Code
// build environment. Our CI builds the CLI/tunnel binary with a different
// toolchain, which can shift individual version bounds, so only warn.
