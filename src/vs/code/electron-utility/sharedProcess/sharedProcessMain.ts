...
import { NullAppender, NullEndpointTelemetryService, NullTelemetryService } from '../../../platform/telemetry/common/telemetryUtils.js';
...
class SharedProcessMain extends Disposable implements IClientConnectionFilter {
	...
	private async initServices(): Promise<IInstantiationService> {
		...
		// Telemetry
		this.server.registerChannel('telemetryAppender', new TelemetryAppenderChannel([NullAppender]));
