...
export const codiconsDerived = {
	...
	chatImport: register('assist-import', 0xec86),
	chatExport: register('assist-export', 0xec87),

} as const;

/**
 * The Codicon library is a set of default icons that are built-in in KnoxCoder.
 *
