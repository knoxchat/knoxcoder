...
export const codiconsLibrary = {
	...
	assist: register('assistant', 0xec1e),
	...
	assistantWarning: register('assistant-warning', 0xec38),
	python: register('python', 0xec39),
	assistantLarge: register('assistant-large', 0xec3a),
	assistantWarningLarge: register('assistant-warning-large', 0xec3b),
	keyboardTab: register('keyboard-tab', 0xec3c),
	assistantBlocked: register('assistant-blocked', 0xec3d),
	assistantNotConnected: register('assistant-not-connected', 0xec3e),
	...
	assistantUnavailable: register('assistant-unavailable', 0xec42),
	...
	assistantInProgress: register('assistant-in-progress', 0xec4c),
	assistantError: register('assistant-error', 0xec4d),
	assistantSuccess: register('assistant-success', 0xec4e),
	chatSparkle: register('assist-sparkle', 0xec4f),
	searchSparkle: register('search-sparkle', 0xec50),
	editSparkle: register('edit-sparkle', 0xec51),
	assistantSnooze: register('assistant-snooze', 0xec52),
	...
	chatSparkleWarning: register('assist-sparkle-warning', 0xec55),
	chatSparkleError: register('assist-sparkle-error', 0xec56),
	...
	assistantCompact: register('assistant-compact', 0xec8a),
