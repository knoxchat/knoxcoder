...
class UserDataProfileExportState extends UserDataProfileImportExportState {
	...
	private createExportPreviewProfile(profile: IUserDataProfile): IUserDataProfile {
		return {
			...
			toolsConfigResource: profile.toolsConfigResource.with({ scheme: USER_DATA_PROFILE_EXPORT_SCHEME }),
			textModelApisResource: profile.textModelApisResource.with({ scheme: USER_DATA_PROFILE_EXPORT_SCHEME }),
