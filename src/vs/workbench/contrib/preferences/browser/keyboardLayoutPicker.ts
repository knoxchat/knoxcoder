...
const DEFAULT_CONTENT: string = [
	`// ${nls.localize('displayLanguage', 'Defines the keyboard layout used in KnoxCoder in the browser environment.')}`,
	`// ${nls.localize('doc', 'Open KnoxCoder and run "Developer: Inspect Key Mappings (JSON)" from Command Palette.')}`,
	``,
