...
export class OnboardingVariationA extends Disposable implements IOnboardingService {
	...
	private _renderSignInStep(container: HTMLElement): void {
		...
		subtitle.textContent = localize('onboarding.signIn.heroSubtitle', "Sign in to sync your settings across devices.");
		...
		append(footer, $('.onboarding-a-signin-disclaimer-col'));
	}
	...
	private _createSignInButton(parent: HTMLElement, providerClass: 'github' | 'google' | 'apple', label: string, options?: { emphasized?: boolean; iconOnly?: boolean; textOnly?: boolean; label?: string }): HTMLButtonElement {
