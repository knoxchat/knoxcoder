...
export class ExtensionsListView extends AbstractExtensionsListView<IExtension> {
	...
	static isInstalledExtensionsQuery(query: string): boolean {
		return /@installed$/i.test(query) && !/@tool/i.test(query) && !/@agentPlugins/i.test(query);
	}

	static isSearchInstalledExtensionsQuery(query: string): boolean {
		return (/@installed\s./i.test(query) && !/@tool/i.test(query) && !/@agentPlugins/i.test(query)) || this.isFeatureExtensionsQuery(query);
	}
