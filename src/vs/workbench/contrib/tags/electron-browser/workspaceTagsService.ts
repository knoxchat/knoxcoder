...
export class WorkspaceTagsService implements IWorkspaceTagsService {
	...
	/* __GDPR__FRAGMENT__
		"WorkspaceTags" : {
			...
			"workspace.npm.@azure/communication-assist" : { "classification": "SystemMetaData", "purpose": "FeatureInsight", "isMeasurement": true },
			...
			"workspace.py.azure-communication-assist" : { "classification": "SystemMetaData", "purpose": "FeatureInsight", "isMeasurement": true },
