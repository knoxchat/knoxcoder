...
/**
 * Allows webviews to monitor when an element in the KnoxCoder editor is being dragged/dropped.
 *
 * This is required since webview end up eating the drag event. KnoxCoder needs to see this
