...
export interface ISCMHistoryProvider {
	...
	resolveHistoryItemAssistContext(historyItemId: string, token?: CancellationToken): Promise<string | undefined>;
	resolveHistoryItemChangeRangeAssistContext(historyItemId: string, historyItemParentId: string, path: string, token?: CancellationToken): Promise<string | undefined>;
