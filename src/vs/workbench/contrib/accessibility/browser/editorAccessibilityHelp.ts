...
const ctxHasEditorModification = new RawContextKey<boolean>('chatEditing.hasEditorModifications', false);
const ctxHasRequestInProgress = new RawContextKey<boolean>('chatEditing.requestInProgress', false);
