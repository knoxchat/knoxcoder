...
import dark_theme from '../../../../../../extensions/theme-onedark-pro/themes/dark.json' with { type: 'json' };
import light_theme from '../../../../../../extensions/theme-defaults/themes/light.json' with { type: 'json' };
/* eslint-enable local/code-import-patterns */

const themeJsonModules: Record<string, string> = {
	'/extensions/theme-onedark-pro/themes/dark.json': dark_theme as unknown as string,
	'/extensions/theme-defaults/themes/light.json': light_theme as unknown as string,
};
...
export const darkTheme = createBuiltInTheme('/extensions/theme-onedark-pro/themes/dark.json', ThemeTypeSelector.VS_DARK, 'theme-onedark-pro');
export const lightTheme = createBuiltInTheme('/extensions/theme-defaults/themes/light.json', ThemeTypeSelector.VS);
