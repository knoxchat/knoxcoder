...
export const enum ShellIntegrationOscPs {
	...
	FinalTerm = 133,
	/**
	 * Sequences pioneered by KnoxCoder. The number is derived from the least significant digit of
 ...
 * the terminal. If multiple shell integration scripts run, KnoxCoder will prioritize the VS
 * Code-specific ones.
 *
...
const enum VSCodeOscPt {
	...
	/**
	 * Set the value of an arbitrary property, only known properties will be handled by KnoxCoder.
	 *
	 ...
	 *   KnoxCoder knows the command line when the execution begins.
	 *
