...
export const enum TerminalSettingId {
	...
	SandboxHostProfileLinux = 'terminal.integrated.sandboxHostProfile.linux',
	SandboxHostProfileMacOs = 'terminal.integrated.sandboxHostProfile.osx',
	SandboxHostProfileWindows = 'terminal.integrated.sandboxHostProfile.windows',
...
export interface IShellLaunchConfig {
	...
	/**
	 * Whether the terminal process environment will inherit KnoxCoder's "shell environment" that may
	 ...
	 * a terminal used to drive some KnoxCoder feature.
	 */
	isFeatureTerminal?: boolean;
	...
	tabActions?: ITerminalTabAction[];
	/**
	 * Report terminal's shell environment variables to KnoxCoder and extensions
	 */
...
export const enum ShellIntegrationStatus {
	...
	FinalTerm,
	/** KnoxCoder shell integration sequences have been encountered. Supercedes FinalTerm. */
	VSCode
}
