...
export type UpdateErrorClassification = {
	...
	comment: 'This is used to know how often KnoxCoder updates have failed.';
};
...
export abstract class AbstractUpdateService extends Disposable implements IUpdateService {
	...
	private async trackVersionChange(): Promise<void> {
		...
		type VersionChangeClassification = {
			owner: 'dmitriv';
			comment: 'Fired when KnoxCoder detects a version change on startup.';
			fromVersion: { classification: 'SystemMetaData'; purpose: 'FeatureInsight'; comment: 'The previous version of KnoxCoder.' };
			...
			toVersion: { classification: 'SystemMetaData'; purpose: 'FeatureInsight'; comment: 'The current version of KnoxCoder.' };
