...
export class BetterTokenStorage<T> {
	...
	// a different window of KnoxCoder and sends the necessary event if it has.
	...
	private async handleSecretChange(e: SecretStorageChangeEvent) {
		...
		// The KeyList is only a list of keys to aid initial start up of KnoxCoder to know which
