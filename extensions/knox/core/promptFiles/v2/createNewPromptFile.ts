...
import { getGlobalPromptsPath } from "../../util/paths";
import { localPathToUri } from "../../util/pathToUri";
import { joinPathsToUri } from "../../util/uri";

const FIRST_TIME_DEFAULT_PROMPT_FILE = `# This is an example ".prompt" file
# It is used to define and reuse prompts within Knox
...
# To learn more, see the full .prompt file reference: https://docs.knox.chat/features/prompt-files
name: Example
...
export async function createNewPromptFileV2(
  ...
  const baseDirUri = promptPath
    ? joinPathsToUri(workspaceDirs[0], promptPath)
    : localPathToUri(getGlobalPromptsPath());
