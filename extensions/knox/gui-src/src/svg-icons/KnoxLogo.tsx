...
const RawIcon = (
  <svg
    ...
    strokeMiterlimit="2"
    className="h-12 lg:h-8 lg:mr-2 mb-5 lg:mb-0"
  >
    ...
    <path d="m23.97 20.03-2.253-2.254-8.595 8.596 2.253 2.253 8.595-8.596v.001z" fill="#d6ffff" /><path d="m15.375 11.434-2.253 2.253 8.595 8.595 2.253-2.253-8.595-8.595z" fill={vscForeground} />
  </svg>
);
