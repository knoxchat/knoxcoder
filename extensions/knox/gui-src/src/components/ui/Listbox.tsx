  ...
  ({ fontSizeModifier = -3, ...props }, ref) => {
    ...
    return (
      <HLButton
        ...
        {...props}
        className={cn(
          "border-knoxcyan/40 bg-vsc-input-background text-knoxcyan m-0 flex flex-1 cursor-pointer flex-row items-center gap-1 border border-solid px-1 py-0.5 text-left transition-colors duration-200",
          props.className,
        )}
        style={{
          fontSize,
