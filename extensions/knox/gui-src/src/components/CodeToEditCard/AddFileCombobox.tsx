        ...
        {({ open }) => (
          <div className="relative">
            ...
            <ComboboxInput
              ...
              className="bg-vsc-background border-lightgray text-vsc-foreground box-border w-full rounded-sm border border-solid py-0.5 pl-2 text-xs focus:outline-hidden"
              onChange={(event) => setQuery(event.target.value)}
              placeholder={t('enterSearchFile')}
              onKeyDown={(e) => {
            ...
            <ComboboxOptions className="no-scrollbar bg-vsc-editor-background border-lightgray/50 absolute left-0 right-0 z-50 mt-1 max-h-60 overflow-y-auto overflow-x-hidden rounded-md border border-solid px-1 py-0 pl-0 pr-5 shadow-lg focus:outline-hidden">
