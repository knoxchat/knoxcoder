...
function MoreHelpRow({ title, description, onClick, Icon }: MoreHelpRowProps) {
  return (
    <div
      className="hover:bg-lightgray/30 flex cursor-pointer items-center justify-between gap-2 rounded-sm px-4 py-2"
      onClick={onClick}
    >
      ...
      <div className="text-lightgray flex h-5 w-5 cursor-pointer justify-end">
        <Icon />
      </div>
    </div>
  );
